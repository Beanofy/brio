  ...
  run: async (client, interaction) => {
    try {
      ...
      const button1 = new ButtonBuilder()
        .setLabel('Support')
        .setURL('https://discord.gg/DKszM7pdV3')
        .setStyle(ButtonStyle.Link);

      const button2 = new ButtonBuilder()
        .setLabel('Add me')
        .setURL('https://discord.com/oauth2/authorize?client_id=1042396919269429248&scope=bot&permissions=332892794064')
        .setStyle(ButtonStyle.Link);

      const button3 = new ButtonBuilder()
        .setLabel('Vote')
        .setURL('https://top.gg/bot/1042396919269429248/vote')
        .setStyle(ButtonStyle.Link);
